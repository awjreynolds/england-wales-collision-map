...
Below 200 matching collisions, the map shows individual severity-coloured collision markers at their recorded coordinates. At 200 or more, display groups keep a minimum six-pixel gap between circle outlines. Display grouping does not change exact totals. Persistent collision sites and school points remain distinct from individual collision markers in the close-up view; coincident records remain selectable.
